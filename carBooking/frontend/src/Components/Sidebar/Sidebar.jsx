    ...
    <div>
      ...
      <div className="sidebar-content">
       ...
       <Link to='/' onClick={()=>setShowSidebar(!showSidebar)}><IoHomeSharp size={22} onClick={()=>setShowSidebar(!showSidebar)}/>Home</Link>
          <Link to='/about' onClick={()=>setShowSidebar(!showSidebar)}><TiInfoLarge size={22} />About Us</Link>
          <Link to='/contact' onClick={()=>setShowSidebar(!showSidebar)}><IoIosContact size={22}/>Contact Us</Link>
