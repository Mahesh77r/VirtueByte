...
const About = () => {
  ...
  return (
    ...
    <div className='about-container'>
        ...
        <h1>Car Rent, <br /><span className='colored-content'>For You</span> </h1>
        <p>Enjoy hassle-free reservations with our easy-to-use booking system. Just a few clicks and you're on your way.</p>
        <div className="about-buttons">
        <a href="#extended-about-us"><button onClick={()=>setExtended(true)}>Read More</button></a>
    ...
    {isExtended?<div className="extended-about-us" id='extended-about-us'>
